...
public class FylkesinndelingMedNavEnheterTest {
    ...
    private Map<String, List<KommuneEllerBydel>> fylkesinndeling;
    ...
    public void fylkesinndeling__skal_sette_kommune_og_bydel_under_tilhoerende_fylkesenhet() {
        fylkesinndeling = FylkesinndelingMedNavEnheter.beregnFylkesinndeling(
        ...
        Assertions.assertThat(fylkesinndeling.get(fylkesenhet_1.getEnhetNr())).contains(kommune_1);
    }

    @Test
    public void fylkesinndeling__skal_handtere_flere_fylker() {
        Map<String, List<KommuneEllerBydel>> resultat = FylkesinndelingMedNavEnheter.beregnFylkesinndeling(
                new HashMap<>() {{
